export default function Home() {
    return (
        <>
            <h2 className="subtitle is-spaced">The companion site</h2>

            <p>This site is a companion to the workshop I held on 7th October 2021 on Jamstack Conference. It has all of the same concepts, plus a few extras that I didn't have time to share with you.</p>
