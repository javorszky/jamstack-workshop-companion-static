...
export default function TablesAlter() {
    ...
    return (
        <>
            ...
            <img src={alterTableIllustration} alt="alter table query colour coded. 'alter' is do what, 'table' is what with, public is schema name, products is table name, 'add' is do what, 'column' is with what, vat_rates is new column name, numeric(5,2) is column type, and null is column constraint" />
